...
main_model_label = pickle.load(open('assets/ldot/labelenodermain.l', 'rb'))
main_model_scale1 = pickle.load(open('minsc/scaler1.s', 'rb'))
main_model_scale2 = pickle.load(open('minsc/scaler2.s', 'rb'))


#NIFTY20 MODELS AND SCALER

asianpaint_mod = pickle.load(open('assets/sdot/asianpaint.sas', 'rb'))
asianpaint_scale = pickle.load(open('assets/ldot/asianpaint_scale.l', 'rb'))

bajajfinsv_mod = pickle.load(open('assets/sdot/bajajfinsv.sas', 'rb')) 
bajajfinsv_scale = pickle.load(open('assets/ldot/bajajfinsv_scale.l', 'rb'))

bharatiartl_mod = pickle.load(open('assets/sdot/bhartiartl.sas', 'rb'))
bharatiartl_scale = pickle.load(open('assets/ldot/bhartiartl_scale.l', 'rb'))

dmart_mod = pickle.load(open('assets/sdot/dmart.sas', 'rb'))
dmart_scale = pickle.load(open('assets/ldot/dmart_scale.l', 'rb'))

hcltech_mod = pickle.load(open('assets/sdot/hcltech.sas', 'rb'))
hcltech_scale = pickle.load(open('assets/ldot/hcltech_scale.l', 'rb'))

hindunilvr_mod = pickle.load(open('assets/sdot/hindunilvr.sas', 'rb'))
hindunilvr_scale = pickle.load(open('assets/ldot/hindunilvr_scale.l', 'rb'))

infy_mod = pickle.load(open('assets/sdot/infy.sas', 'rb'))
infy_scale = pickle.load(open('assets/ldot/infy_scale.l', 'rb'))

itc_mod = pickle.load(open('assets/sdot/itc.sas', 'rb'))
itc_scale = pickle.load(open('assets/ldot/itc_scale.l', 'rb'))

lt_mod = pickle.load(open('assets/sdot/lt.sas', 'rb'))
lt_scale = pickle.load(open('assets/ldot/lt_scale.l', 'rb'))

maruti_mod = pickle.load(open('assets/sdot/maruti.sas', 'rb'))
maruti_scale = pickle.load(open('assets/ldot/maruti_scale.l', 'rb'))

reliance_mod = pickle.load(open('assets/sdot/reliance.sas', 'rb'))
reliance_scale = pickle.load(open('assets/ldot/reliance_scale.l', 'rb'))

tcs_mod = pickle.load(open('assets/sdot/tcs.sas', 'rb'))
tcs_scale = pickle.load(open('assets/ldot/tcs_scale.l', 'rb'))

ultracemco_mod = pickle.load(open('assets/sdot/ultracemco.sas', 'rb'))
ultracemco_scale = pickle.load(open('assets/ldot/ultracemco_scale.l', 'rb'))

wipro_mod = pickle.load(open('assets/sdot/wipro.sas', 'rb'))
wipro_scale = pickle.load(open('assets/ldot/wipro_scale.l', 'rb'))

#NIFTY BANK MODELS AND SCALER

aubank_mod = pickle.load(open('assets/sdot/aubank.sas', 'rb'))
aubank_scale = pickle.load(open('assets/ldot/aubank_scale.l', 'rb'))

axisbank_mod = pickle.load(open('assets/sdot/axisbank.sas', 'rb'))
axisbank_scale = pickle.load(open('assets/ldot/axisbank_scale.l', 'rb'))

bandhanbnk_mod = pickle.load(open('assets/sdot/bandhanbnk.sas', 'rb'))
bandhanbnk_scale = pickle.load(open('assets/ldot/bandhanbnk_scale.l', 'rb'))

bankbaroda_mod = pickle.load(open('assets/sdot/bankbaroda.sas', 'rb'))
bankbaroda_scale = pickle.load(open('assets/ldot/bankbaroda_scale.l', 'rb'))

federalbnnk_mod = pickle.load(open('assets/sdot/federalbnk.sas', 'rb'))
federalbnk_scale = pickle.load(open('assets/ldot/federalbnk_scale.l', 'rb'))

hdfcbank_mod = pickle.load(open('assets/sdot/hdfcbank.sas', 'rb'))
hdfcbank_scale = pickle.load(open('assets/ldot/hdfcbank_scale.l', 'rb'))

icicibank_mod = pickle.load(open('assets/sdot/icicibank.sas', 'rb'))
icicibank_scale = pickle.load(open('assets/ldot/icicibank_scale.l', 'rb'))

idfc_mod = pickle.load(open('assets/sdot/idfc.sas', 'rb'))
idfc_scale = pickle.load(open('assets/ldot/idfc_scale.l', 'rb'))

indusindbk_mod = pickle.load(open('assets/sdot/indusindbk.sas', 'rb'))
indusindbk_scale = pickle.load(open('assets/ldot/indusindbk_scale.l', 'rb'))

kotakbank_mod = pickle.load(open('assets/sdot/kotakbank.sas', 'rb'))
kotakbank_scale = pickle.load(open('assets/ldot/kotakbank_scale.l', 'rb'))

pnb_mod = pickle.load(open('assets/sdot/pnb.sas', 'rb'))
pnb_scale = pickle.load(open('assets/ldot/pnb_scale.l', 'rb'))

sbin_mod = pickle.load(open('assets/sdot/sbin.sas', 'rb'))
sbin_scale = pickle.load(open('assets/ldot/sbin_scale.l', 'rb'))



#PHARMA SECTOR MODELS AND SCALER

alkem_mod = pickle.load(open('assets/sdot/alkem_mode.sas', 'rb'))
alkem_scale = pickle.load(open('assets/ldot/alkem_scale.l', 'rb'))

auropharma_mod = pickle.load(open('assets/sdot/auropharma.sas', 'rb'))
auropharma_scale = pickle.load(open('assets/ldot/auropharma_scale.l', 'rb'))

biocon_mod = pickle.load(open('assets/sdot/biocon.sas', 'rb'))
biocon_scale = pickle.load(open('assets/ldot/biocon_scale.l', 'rb'))

cipla_mod = pickle.load(open('assets/sdot/cipla.sas', 'rb'))
cipla_scale = pickle.load(open('assets/ldot/cipla_scale.l', 'rb'))

drreddy_mod = pickle.load(open('assets/sdot/drreddy.sas', 'rb'))
drreddy_scale = pickle.load(open('assets/ldot/drreddy_scale.l', 'rb'))

glenmark_mod = pickle.load(open('assets/sdot/glenmark.sas', 'rb'))
glenark_scale = pickle.load(open('assets/ldot/glenmark_scale.l', 'rb'))

ipcalab_mod = pickle.load(open('assets/sdot/ipcalab.sas', 'rb'))
ipcalab_scale = pickle.load(open('assets/ldot/ipcalab_scale.l', 'rb'))

jbchepharm_mod = pickle.load(open('assets/sdot/jbchepharm.sas', 'rb'))
jbchepharm_scale = pickle.load(open('assets/ldot/jbchepharm_scale.l', 'rb'))

lupin_mod = pickle.load(open('assets/sdot/lupin.sas', 'rb'))
lupin_scale = pickle.load(open('assets/ldot/lupin_scale.l', 'rb'))

sunpharma_mod = pickle.load(open('assets/sdot/sunpharma.sas', 'rb'))
sunpharma_scale = pickle.load(open('assets/ldot/sunpharma_scale.l', 'rb'))

suven_mod = pickle.load(open('assets/sdot/suven.sas', 'rb'))
suven_scale = pickle.load(open('assets/ldot/suven_scale.l', 'rb'))

syngene_mod = pickle.load(open('assets/sdot/syngene.sas', 'rb'))
syngene_scale = pickle.load(open('assets/ldot/syngene_scale.l', 'rb'))

zyduslife_mod = pickle.load(open('assets/sdot/zyduslife.sas', 'rb'))
zyduslife_scale = pickle.load(open('assets/ldot/zyduslife_scale.l', 'rb'))

st.sidebar.image('api_assets/logo.png')
with st.sidebar:
...
if (selected == 'HOME'):
    ...
    st.image("api_assets/graph3.jpg")
...
if (selected == 'PREDICT'):
    ...
    if st.button("PREDICT"):
        ...
        try:
            ...
            pred = "Data currently unavailable"
...
if (selected == 'NIFTY 20'):
    ...
    if st.button("ASIANPAINT"):
        try:
            ...
            asianpaint = "Data currently unavailable"
            print(asianpaint)
...
if (selected == 'NIFTY PHARMA'):
    ...
    if st.button("ALKEM"):
        try:
            ...
            alkem = "Data currently unavailable"
            print(alkem)
    st.success(alkem)
    ...
    if st.button("AUROPHARMA"):
        try:
            ...
            auropharma = "Data currently unavailable"
            print(auropharma)
    ...
    if st.button("BIOCON"):
        try:
            ...
            biocon = "Data currently unavailable"
            print(biocon)
    st.success(biocon)
    ...
    if st.button("CIPLA"):
        try:
            ...
            cipla = "Data currently unavailable"
            print(cipla)
    st.success(cipla)
    ...
    if st.button("DRREDDY"):
        try:
            ...
            drreddy = ("Data currently unavailable")
            print(drreddy)
    st.success(drreddy)
    ...
    if st.button("GLENMARK"):
        try:
            ...
            glenmark = "Data currently unavailable"
            print(glenmark)
    st.success(glenmark)
    ...
    if st.button("IPCALAB"):
        try:
            ...
            ipcalab = "Data currently unavailable"
            print(ipcalab)
    st.success(ipcalab)
    ...
    if st.button("JBCHEPHARM"):
        try:
            ...
            jbchepharm = "Data currently unavailable"
            print(jbchepharm)
    ...
    if st.button("LUPIN"):
        try:
            ...
            lupin = "Data currrently unavailable"
            print(lupin)
    st.success(lupin)
    ...
    if st.button("SUNPHARMA"):
        try:
            ...
            sunpharma = "Data currently unavailable"
            print(sunpharma)
    ...
    if st.button("SUVEN"):
        try:
            ...
            suven = "Data currently unavaialble"
            print(suven)
    st.success(suven)
    ...
    if st.button("SYNGENE"):
        try:
            ...
            syngene = "Data currently unavailable"
            print(syngene)
    st.success(syngene)
    ...
    if st.button("ZYDUSLIFE"):
        try:
            ...
            zyduslife = "Data currently unavailable"
            print(zyduslife)
...
if (selected == 'ABOUT'):
    ...
    st.image("api_assets/pngwing.com.png")
